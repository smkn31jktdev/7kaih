...
} from "@/app/components/dashboard/admin/kegiatan/bermasyarakat";
import type { BermasyarakatStudent } from "@/app/components/dashboard/admin/kegiatan/bermasyarakat/types";
import { BERMASYARAKAT_DESKRIPSI_MAP } from "@/app/components/dashboard/admin/kegiatan/bermasyarakat/types";
import {
  extractMonthKeys,
...
export default function AdminBermasyarakatPage() {
  ...
  const handleDownloadPDF = async () => {
    ...
    filteredEntries.forEach((entry) => {
      ...
      const splitHeight = splitJenis.length * 5;
