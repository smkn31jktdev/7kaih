...
import { Check, Users, X, ArrowDownToLine } from "lucide-react";
import Select from "@/app/components/Select";
import type { BermasyarakatStudent, BermasyarakatEntry } from "./types";
import { BERMASYARAKAT_DESKRIPSI_MAP } from "./types";
import { formatDisplayDate, formatMonthLabel } from "../utils";

interface BermasyarakatDetailModalProps {
  student: BermasyarakatStudent;
  filteredEntries: BermasyarakatEntry[];
...
function getDeskripsiLabel(key: string): string {
  return BERMASYARAKAT_DESKRIPSI_MAP[key] || key;
}

export default function BermasyarakatDetailModal({
  student,
  filteredEntries,
  selectedMonth,
  availableMonths,
