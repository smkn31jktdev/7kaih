...
import { MoveRight, Search, Filter, BookOpen } from "lucide-react";
import type { BelajarStudent } from "./types";

interface BelajarStudentListProps {
  students: BelajarStudent[];
  searchQuery: string;
  onSearchChange: (query: string) => void;
  onSelectStudent: (student: BelajarStudent) => void;
}

export default function BelajarStudentList({
  students,
  searchQuery,
  onSearchChange,
  onSelectStudent,
}: BelajarStudentListProps) {
