...
import { Check, BookOpen, X, ArrowDownToLine } from "lucide-react";
import Select from "@/app/components/Select";
import type { BelajarStudent, BelajarEntry } from "./types";
import { BELAJAR_DESKRIPSI_MAP } from "./types";
import { formatDisplayDate, formatMonthLabel } from "../utils";

interface BelajarDetailModalProps {
  student: BelajarStudent;
  filteredEntries: BelajarEntry[];
...
export default function BelajarDetailModal({
  student,
  filteredEntries,
  selectedMonth,
  availableMonths,
