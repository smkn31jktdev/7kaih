...
import { Check, Utensils, X, ArrowDownToLine } from "lucide-react";
import Select from "@/app/components/Select";
import type { MakanStudent, MakanEntry } from "./types";
import { formatDisplayDate, formatMonthLabel } from "../utils";

interface MakanDetailModalProps {
  student: MakanStudent;
  filteredEntries: MakanEntry[];
...
export default function MakanDetailModal({
  student,
  filteredEntries,
  selectedMonth,
  availableMonths,
              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-gray-50 text-gray-500 font-semibold border-b border-gray-200 sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="px-6 py-4 min-w-[150px]">Jenis Makanan</th>
