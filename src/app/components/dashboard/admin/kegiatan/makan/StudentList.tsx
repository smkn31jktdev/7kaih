...
import { MoveRight, Search, Filter, Utensils } from "lucide-react";
import type { MakanStudent } from "./types";

interface MakanStudentListProps {
  students: MakanStudent[];
  searchQuery: string;
  onSearchChange: (query: string) => void;
  onSelectStudent: (student: MakanStudent) => void;
}

export default function MakanStudentList({
  students,
  searchQuery,
  onSearchChange,
  onSelectStudent,
}: MakanStudentListProps) {
